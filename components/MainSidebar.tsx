...
const MainSidebar: React.FC<MainSidebarProps> = ({ activeView, setActiveView }) => {
  const navItems = [
  ...
  return (
    <aside className="w-64 bg-slate-800 p-4 flex-shrink-0 flex flex-col border-r border-slate-700 hidden md:flex">
      ...
      <div className="mt-auto p-4 bg-slate-900/50 rounded-lg text-center border border-slate-700">
