...
5.  Clicking the button must toggle the \`.dark-mode\` class on the body, changing the page's appearance.`
  ...
  // 2. Python Programming
  {
    ...
    structure: [
      { day: 1, module: 'Python Basics', topic: 'Introduction to Python', notes: 'Discover Python, its uses, and set up your development environment (install Python and a code editor like VS Code).', challenge: { title: 'Hello, World!', description: 'Write and run your first Python script that prints "Hello, World!" to the console.' } },
      ...
      { day: 8, module: 'Data Structures & Loops', topic: 'For Loops', notes: 'Master `for` loops to iterate over sequences like lists and strings.', challenge: { title: 'Print List Items', description: 'Create a list of your favorite foods and use a `for` loop to print each food item on a new line.' } },
      ...
      { day: 15, module: 'Functions & Modules', topic: 'Introduction to Functions', notes: 'Learn to define and call your own functions to write reusable and organized code.', challenge: { title: 'Greeting Function', description: 'Write a function that takes a name as an argument and prints a personalized greeting.' } },
      ...
      { day: 25, module: 'Intermediate Python', topic: 'Introduction to Object-Oriented Programming (OOP)', notes: 'Understand the basic concepts of OOP: classes and objects.', challenge: { title: 'Create a `Dog` Class', description: 'Create a simple `Dog` class with attributes for `name` and `breed`. Create two different dog objects from this class.' } },
